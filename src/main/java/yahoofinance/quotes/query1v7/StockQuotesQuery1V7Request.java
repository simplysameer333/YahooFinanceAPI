...
public class StockQuotesQuery1V7Request extends QuotesRequest<Stock> {
    ...
    public Stock parseJson(JsonNode node) {
        ...
        stock.setLongName(getStringValue(node, "longName"));
        ...
        stock.setMarketState(getStringValue(node, "marketState"));
        stock.setRegularMarketTime(getStringValue(node, "regularMarketTime"));
        stock.setRegularMarketPrice(getStringValue(node, "regularMarketPrice"));
        stock.setRegularMarketDayHigh(getStringValue(node, "regularMarketDayHigh"));
        stock.setRegularMarketDayLow(getStringValue(node, "regularMarketDayLow"));
        stock.setRegularMarketChange(getStringValue(node, "regularMarketChange"));
        stock.setRegularMarketChangePercent(getStringValue(node, "regularMarketChangePercent"));
